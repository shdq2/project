...
<link rel="stylesheet" href="resources/css/password_edit.css" />
...
<body>
	...
	<div class="profile-container">
		...
		<div class="profile-main">
			...
			<div class="main-content">
				...
				<input type="submit" id="btn-update" class="btn btn-primary" value="비밀번호 업데이트" />
 				</form>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="resources/js/password_edit.js"></script>
	<script>
		$(function() {
