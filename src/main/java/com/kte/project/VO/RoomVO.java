...
public class RoomVO {
	 ...
	 * 룸 이미지 vo
	 * */
	private String room_code = null; // 숙소 등록 번호 => 숙소 관련 vo 공용
	// 룸 이미지
	...
	// 룸 이미지
	private String room_img_date =null; // 이미지 등록 날짜
	/*
	 * 룸 이미지 vo
	 * */
	 ...
	 * 룸 옵션 vo
	 * */
	private String ro_option = null;	// 숙소 기본 옵션
	private String ro_option2 = null;	// 숙소 추가옵션
	private String ro_security = null;	// 숙소 보안사항
	private String ro_date = null;		// 옵션 등록 일자
	 ...
	 * 룸 vo
	 * */
	private String room_name = null;	//숙소 이름
	private String room_content = null;	//숙소 설명
	private String room_price = null;	//숙소 가격 (1박기준)
	private String room_date = null;	//숙소 등록 일자
	private String room_block= null;	//숙소를 리스트에 추가할지 말지 여부
	private String room_addr = null;	//숙소 주소
	/*
	 * 룸 vo
	 * */
	 ...
	 * 지역 vo
	 * */
	private String region_name = null;	//숙소가 등록된 지역 이름
	private int region_no = 0;			//지역 번호
