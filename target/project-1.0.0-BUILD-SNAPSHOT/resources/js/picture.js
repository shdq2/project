function w_resize() {
	if(width <= 768) {
		...
		$('.user-picture-list img').css('height','270px');
		$('.user-picture-list').css('height','270px');
		$('.user-picture').css('height','145px');
		...
		$('.user-picture-list img').css('height','190px');
		$('.user-picture-list').css('height','');
		$('.user-picture').css('height','145px');
	}
	if(width>=992){
		$('.user-picture-list img').css('height','130px');
	}
}
