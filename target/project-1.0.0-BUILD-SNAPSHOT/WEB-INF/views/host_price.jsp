										...
										<c:forEach items="${list}" var="vo" varStatus="i">
											<tr>
												<td align="center" style="vertical-align:middle">
													<a href="#" class="term_fix_button">${vo.busy_month_start}${vo.busy_day_start} - ${vo.busy_month_end}${vo.busy_day_end}</a><i class="glyphicon glyphicon-remove" id="remove_btn"></i>
												</td>
												<td>
													<table class="table">
														<thead>
